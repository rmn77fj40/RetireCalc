...
function calculateRetirement() {
    ...
    if (lastCalculatedResults.length > 0) { // Only update if there's data
        ...
        // If no data was generated, reset summary fields or display a message
        document.getElementById('summaryRobAge').textContent = '--';
        document.getElementById('summarySonjaAge').textContent = '--';
        document.getElementById('balanceAtRobRetirement').textContent = '--';
        document.getElementById('balanceAtEndOfPlan').textContent = '--';
        document.getElementById('shortfallYear').textContent = '--';
        console.warn("No projection data generated. Check input values or validation logic.");
    }
